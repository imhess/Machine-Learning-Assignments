...
# SPECIFICATION: Complete the Python program (deep_learning.py) that will learn how to
...
for h in n_hidden:                          #looking or the best parameters w.r.t the number of hidden layers
    for n in n_neurons:                      #looking or the best parameters w.r.t the number of neurons
        for l in l_rate:                  #looking or the best parameters w.r.t the learning rate
            ...
            correct = 0
            counter = 0
            for y_test_sample in y_test:
               if class_predicted[counter] == y_test_sample:
                  correct += 1
               total += 1
               counter += 1
            ...
            if accuracy > highest_accuracy:
                ...
                print("Highest accuracy so far: " + str(accuracy_rounded))
